<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"/var/www/html/pluralisticShop/public/../application/index/view/orders/address.html";i:1510125784;s:81:"/var/www/html/pluralisticShop/public/../application/index/view/public/header.html";i:1508755522;s:78:"/var/www/html/pluralisticShop/public/../application/index/view/public/nav.html";i:1508834615;s:81:"/var/www/html/pluralisticShop/public/../application/index/view/public/footer.html";i:1508310080;}*/ ?>
     ...
     <div class="address clearfix">
       <div class="title">收货人信息</div>
          <div class="adderss_list clearfix">
            <div class="title_name">选择收货地址 <a href="<?php echo url('orders/addresshtml'); ?>">+添加地址</a></div>
     ...
     选择已有红包<select name="somename" class="SlectBox" onclick="console.log($(this).val())" onchange="console.log('change is firing')">
      ...
      <table>
       ...
       <tr>
        ...
        <td><i>￥</i><span id="youhui_<?php echo $wo['id']; ?>"><?php echo $wo['originalprice'] - $wo['price']; ?></span></td>
