<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"/var/www/html/pluralisticShop/public/../application/admin/view/index/home.html";i:1508658713;}*/ ?>
...
<div class="page-content clearfix">
 ...
 <div class="clearfix">
  <div class="home_btn">
     ...
     <a href="<?php echo url('admin/pictureadd/pictureadd'); ?>"  title="添加商品" class="btn  btn-info btn-sm no-radius">
     <i class="bigger-200"><img src="/static/admin/images/icon-addp.png" /></i>
     <h5 class="margin-top">添加商品</h5>
     </a>

     <a href="<?php echo url('admin/categorymanage/categorymanage'); ?>"  title="产品分类" class="btn  btn-primary btn-sm no-radius">
