<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"/var/www/html/pluralisticShop/public/../application/admin/view/article/article-add.html";i:1508729304;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text"  name="commentdatemin" class="input-text Wdate">
			</div>
		</div>
		<div class="row cl">
