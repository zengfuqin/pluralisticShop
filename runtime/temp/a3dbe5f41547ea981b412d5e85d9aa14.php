<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"/var/www/html/pluralisticShop/public/../application/admin/view/product/product-brand.html";i:1508673498;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<table class="table table-border table-bordered table-bg table-sort">
			...
			<tbody>
				<tr class="text-c">
					...
					<td><img src="/static/admin/temp/brand/dongpeng.jpeg"></td>
					<td class="text-l"><img title="国内品牌" src="/static/admin/static/h-ui.admin/images/cn.gif"> 东鹏</td>
